...
const dbConnect = async () => {
    try {
        await mongoose.connect("mongodb+srv://laxmanpanjalingam2004:sairam@cluster0.bslmqko.mongodb.net/TravelBlog3?retryWrites=true&w=majority&appName=Cluster0");
...
app.put("/getblogposts/update/:id", uploadMiddleware.single("file"), async (req, res) => {
